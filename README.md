...
2. [Install Ukrainian Language Pack](#2-how-to-install-hungarian-language-pack)
3. [How to active Ukrainian language pack](#3-how-to-active-hungarian-language-pack)
...
## 3. How to active Ukrainian language pack {#active}
